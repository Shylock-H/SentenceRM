...
from openrlhf.trainer.dense_srm_ppo_utils import Experience, RemoteExperienceMaker
from openrlhf.trainer.dense_srm_ray.vllm_engine import batch_vllm_engine_call
...
from openrlhf.utils.remote_seq_rm_utils import remote_rm_fn_ray
...
class ActorPPOTrainer(BasePPOTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        if self.strategy.args.use_wandb and self.strategy.is_rank_0():
            ...
            os.environ["WANDB_DIR"] = self.strategy.args.save_path
    ...
    def fit(
        ...
        if args.eval_steps == -1:
            args.eval_steps = num_rollouts_per_episodes + 1  # Evaluate once per epoch
        if args.save_steps == -1:
            # args.save_steps = float("inf")  # do not save ckpt
            args.save_steps = num_rollouts_per_episodes // 2
